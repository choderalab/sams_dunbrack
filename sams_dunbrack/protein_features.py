...
def features(pdb, chain, numbering):
    ...
    for line in atoms:
        ...
        if line[5] == chain_index:
            ...
            dih[5][2] = count if line[3] == numbering[80] and line[
                1] == 'CB' else dih[5][2]
            dih[5][3] = count if line[3] == numbering[80] and line[
                1] == 'CG' else dih[5][3]
            dih[6][0] = dih[5][1]
            dih[6][1] = dih[5][2]
            dih[6][2] = dih[5][3]
            dih[6][3] = count if line[3] == numbering[80] and line[
                1] == 'OD1' else dih[6][3]
            ...
            dih[8][1] = dih[7][2]
            dih[8][2] = dih[7][3]
            dih[8][3] = count if line[3] == numbering[82] and line[
                1] == 'N' else dih[8][3]

            # dihedral 9: DFG-Phe Chi
            dih[9][0] = dih[4][3] #DFG-Phe N
            dih[9][1] = dih[7][2] #DFG-Phe CA
            dih[9][2] = count if line[3] == numbering[81] and line[
                1] == 'CB' else dih[9][2] # DFG-Phe CB
            dih[9][3] = count if line[3] == numbering[81] and line[
                1] == 'CG' else dih[9][3] # DFG-Phe CG
